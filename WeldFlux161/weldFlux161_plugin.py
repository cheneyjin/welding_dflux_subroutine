...
class WeldFlux161_plugin(AFXForm):
    ...
    def getFirstDialog(self):
        ...
        import weldFlux161DB
        return weldFlux161DB.WeldFlux161DB(self)
...
toolset.registerGuiMenuButton(
    buttonText='WeldFlux161', 
    object=WeldFlux161_plugin(toolset),
    messageId=AFXMode.ID_ACTIVATE,
    icon=None,
    kernelInitString='import T_plain161',
