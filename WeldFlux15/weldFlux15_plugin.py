...
class WeldFlux15_plugin(AFXForm):
    ...
    def __init__(self, owner):
        ...
        self.cmd = AFXGuiCommand(mode=self, method='kernel',
            objectName='T_plain15', registerQuery=False)
        pickedDefault = ''
    ...
    def getFirstDialog(self):
        ...
        import weldFlux15DB
        return weldFlux15DB.WeldFlux15DB(self)
...
toolset.registerGuiMenuButton(
    buttonText='WeldFlux15', 
    object=WeldFlux15_plugin(toolset),
    messageId=AFXMode.ID_ACTIVATE,
    icon=None,
    kernelInitString='import T_plain15',
